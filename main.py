...
# ============================================================
# ATAQUES ESPACIALES
# Menú mejorado + 4 direcciones + Layouts de controles + Jefes
# ============================================================
...
def reset_game():
    ...
    # Posición inicial del jugador (más centrada verticalmente)
...
# ------------------------------------------------------------
# BOTONES DE CONTROL (se recalculan según layout)
# ------------------------------------------------------------
...
def crear_botones_control():
    ...
    else:  # COMPACTO (recomendado para evitar barra del celular)
...
while ejecutando:
    ...
    # Límites verticales del jugador
        ...
        if tipo_control == 'BOTONES':
            ...
            if pygame.mouse.get_pressed()[0]:
                ...
                if not btn_pausa_rect.collidepoint(pos_touch):
                    # Movimiento suave hacia el dedo (4 direcciones)
    ...
    # ===== OPCIONES =====
        ...
        # Mini preview de los botones del layout actual
    ...
    # ===== JUEGO =====
        ...
        # Botones de control según layout
        if tipo_control == 'BOTONES':
